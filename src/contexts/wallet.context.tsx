...
export function WalletContextProvider(props: WalletContextProps): JSX.Element {
  ...
  const [walletConnectBlockchain, setWalletConnectBlockchain] = useState<Blockchain>();
  ...
  async function connect(
    ...
    switch (wallet) {
      ...
      case WalletType.WALLET_CONNECT:
        setWalletConnectBlockchain(blockchain);
        break;
    }
  ...
  async function signMessage(wallet: WalletType, message: string, address: string): Promise<string> {
    switch (wallet) {
      ...
      case WalletType.WALLET_CONNECT:
        return await walletConnect.signMessage(message, address, walletConnectBlockchain ?? Blockchain.ETHEREUM);
  ...
  function getBlockchain(wallet?: WalletType): Blockchain | undefined {
    switch (wallet ?? activeWallet) {
      ...
      case WalletType.WALLET_CONNECT:
        return walletConnectBlockchain;
