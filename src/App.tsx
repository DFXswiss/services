...
const ComplianceKycFileListScreen = lazy(() => import('./screens/compliance-kyc-file-list.screen'));
...
export const Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'compliance/kycFileList',
        element: withSuspense(<ComplianceKycFileListScreen />),
      },
      {
        path: 'realunit',
        element: (
