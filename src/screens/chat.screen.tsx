...
interface InputComponentProps {
  chat: SupportIssue;
  setChat: React.Dispatch<React.SetStateAction<SupportIssue>>;
  replyToMessage?: SupportMessage;
  setReplyToMessage: React.Dispatch<React.SetStateAction<SupportMessage | undefined>>;
}

function InputComponent({ chat, setChat, replyToMessage, setReplyToMessage }: InputComponentProps): JSX.Element {
