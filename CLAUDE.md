...
**YOU ARE IN: `services/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/services/` (rig root) or other directories
...
**Your mail address:** `services/polecats/obsidian`
**Your rig:** services
**Your Witness:** `services/witness`
...
| Ask Witness for help | `gt mail send services/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`services/witness`) when:
...
```bash
gt mail send services/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
